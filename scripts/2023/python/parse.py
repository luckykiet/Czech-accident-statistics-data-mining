...
dictionary = {
    ...
    "p29a": {"label": "Reflexni prvky u chodce", "items": {"1": "ano", "2": "ne"}},
    "p29b": {
        "label": "Chodec na osobnim prepravniku",
        "items": {"1": "ano", "2": "ne"},
    },
    ...
    "p30": {
        ...
        "items": {
            ...
            "9": "pod vlivem alkoholu - obsah alkoholu v krvi 1 promile a více",
            "0": "nezjištěno",
        },
    },
    "p30a": {
    ...
    "p33e": {"label": "Statni prislusnost chodce", "items": {}, "skipIntParse": True},
    "p33f": {
    ...
    "p45b": {"label": "Údaje o vozidle", "items": {}},
    "p45d": {
        "label": "Druh pohonu / paliva",
        "items": {
            "01": "diesel",
            "02": "benzín",
            "03": "LPG",
    ...
    "p45f": {
        "label": "Druh pneumatik vozidla",
        "items": {"01": "letní", "02": "zimní", "03": "celoroční", "00": "nezjištěno"},
    },
